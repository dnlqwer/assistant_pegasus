...
Например, если есть команда: "таймер", по фразе "Пегас таймер пять" будет 
...
Обычно фразы должны начинаться с имени помощника (Пегас).

Но иногда хочется сделать красиво - например, если мы делаем голосовую игру, 
было бы странно каждый раз говорить Пегас. Или можно уточнить - "что там после слова таймер?"
